...
if [ -f "/tmp/nxp-eula-accepted" ]; then
  ...
  echo "WARNING: NXP EULA has been auto-accepted; this implies you agree with it anyway."
...
environment variable ACCEPT_FSL_EULA=1 to accept the EULA non-interactively.
EOMESSAGE
    exit 1
  fi
